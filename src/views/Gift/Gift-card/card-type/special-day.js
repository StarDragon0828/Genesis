...
export default function SpecialDay(props) {
    ...
    return(
        <View className="special-page" >
            <h5 className='giftcard-link' ><Link to="/giftcard" className='link-none'>Gift Card Page</Link> <span className='ms-2'>&gt;</span><span className='text-primary ms-2'>SpecialDay Gift Card</span></h5>
            <View className="special-card-main" >
                <h5 className='title' >Special Day Gift Card<span>(Valentine's Day, Women's Day,Man's day, Beautiful Day, A gift for Christmas)</span></h5> 
                <View className="details" >
                    <View className="card-details" >
                        {specialDay.giftCard.map((item) => (

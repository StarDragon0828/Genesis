...
export default function SpecialDay(props) {
    ...
    return(
        <View className="special-page" >
            <h5 className='giftcard-link' ><Link to="/giftcard" className='link-none'>Gift Card Page</Link> <span className='ms-2'>&gt;</span><span className='text-primary ms-2'>Valentine's Day Gift Card</span></h5>

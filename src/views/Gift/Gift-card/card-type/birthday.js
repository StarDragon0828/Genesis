...
export default function Birthday(props) {
    ...
    return(
        <View className="birthday-page" >
            <h5 className='giftcard-link' ><Link to="/giftcard" className='link-none'>Gift Card Page</Link> <span className='ms-2'>&gt;</span><span className='text-primary ms-2'>Birthday Gift Card</span></h5>
            <View className="birthday-card-main" >
                <h5 className='title' >Birthday Gift Card</h5> 
                <View className="details" >
                    <View className="card-details" >
                        {birthday.giftCard.map((item) => (

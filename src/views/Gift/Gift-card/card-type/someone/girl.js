...
export default function GirlfriendCard(props) {
    ...
    return(
        <View className="someone-page" >
            <h5 className='giftcard-link' ><Link to="/giftcard" className='link-none'>Gift Card Page</Link> <span className='ms-2'>&gt;</span><span className='text-primary ms-2'>GirlFriend</span></h5>
